            ...
            <form class="flex flex-col gap-4" @submit.prevent="submit">
                <div>
                    <label class="input input-bordered input-accent flex items-center gap-2">
                        ...
                        <input type="text" class="grow" placeholder="Usuário" v-model="form.login" />
                    </label>
                </div>
                <div>
                    <label class="input input-bordered input-accent flex items-center gap-2">
                        ...
                        <input type="password" class="grow" placeholder="Senha" v-model="form.password" />
                    </label>
                </div>
                <div class="flex flex-row gap-2 items-center">
                    <input class="checkbox checkbox-accent" type="checkbox" id="remember_me" v-model="form.remember_me">
