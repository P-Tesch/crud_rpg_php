...
const props = defineProps({defaultValue: Number, title: String});
    ...
    <dialog class="modal" ref="modalRef">
        <div class="modal-box w-11/12 max-w-5xl outline outline-primary overflow-auto">
            ...
            <form method="dialog" class="flex gap-5">
                ...
                <input v-model="input" type="number" class="input input-bordered input-primary w-full" id="numberInput" />
